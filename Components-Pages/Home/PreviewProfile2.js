...
export default function PreviewProfile2(props) {
    ...
    if (user) {return (
        <HomeContainer isViewAsTeacher={false} tabs={tabs} footer={null} user={user}  isShowWhereby = {true}>
            <TeacherProfile user={user} isShowFooter={false} userObject={userObject} seeResume={true} />
        </HomeContainer>
