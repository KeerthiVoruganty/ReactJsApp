...
import ShareProfileNav from "../../Components/Navbar/ShareProfileNav";
...
const ShareProfile = (props) => {
  ...
  user.can_deliver.forEach((c) => {
    if (
      ...
      c.can_deliver === "Business English" ||
      ...
      c.can_deliver === "Assistant Academic Manager" ||
                                    ...
                                    >
                                      {user.qualifications &&
                                        ...
                                        ? user.qualifications
                                          .sort((a, b) => {
                                            var dateA = new Date(
                                              "01/" + a.graduation_date
                                            ),
                                              dateB = new Date(
                                                "01/" + b.graduation_date
                                              );
                                            return dateB - dateA;
                                          })
                                          .map((q) => {
