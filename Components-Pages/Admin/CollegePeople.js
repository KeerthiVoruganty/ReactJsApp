...
export class CollegePeople extends Component {
  constructor(props) {
    super(props);
                              ...
                              <div className="">
                                ...
                                <div className="">
                                  ...
                                  <div className="d-flex mb-4">
                                    <div className="light-blue-border mr-3"></div> <h5 className="mb-0 mt-3 w-fillava">Manager</h5> <div className="light-blue-border ml-3"></div>
                                  </div>
                                  <div className="auth-text-top mb-3 row">
                                    <div className="form-group col-md-12 col-lg-6  my-1 d-flex line-height-24">
                                      ...
                                      <div className="input-icon ml-2 text-left line-height-24">
                                        <p className="font-17 text-capitalize  line-height-24">Manager-name</p>
                                      </div>
                                    </div>
                                    <div className="form-group col-md-12 col-lg-6 my-1 d-flex line-height-24">
                                      <label className=" line-height-24"><p className="text-left mb-0  line-height-24">Family Name:</p></label>
                                      <div className="input-icon ml-2 text-left line-height-24">
                                        <p className="font-17 text-capitalize  line-height-24">Manager-faminly-name</p>
                                      </div>
                                    </div>
                                    <div className="form-group col-md-12 col-lg-6 my-1 d-flex line-height-24">
                                      <label className=" line-height-24"><p className="text-left mb-0  line-height-24">Email:</p></label>
                                      <div className="input-icon ml-2 text-left line-height-24">
                                        <p className="font-17 text-capitalize  line-height-24">Manager-email</p>
                                      </div>
                                    </div>
                                    <div className="form-group col-md-12 col-lg-6 my-1 d-flex line-height-24">
                                      <label className=" line-height-24"><p className="text-left mb-0  line-height-24">Phone Number:</p></label>
                                      <div className="input-icon ml-2 text-left line-height-24">
                                        <p className="font-17 text-capitalize  line-height-24">Manager-phone</p>
                                      </div>
                                    </div>
                                    <div className="form-group col-md-12 col-lg-6 my-1 d-flex line-height-24">
                                      <label className=" line-height-24"><p className="text-left mb-0  line-height-24">Campus:</p></label>
                                      <div className="input-icon ml-2 text-left line-height-24">
                                        <p className="font-17 text-capitalize  line-height-24">Campus-name / Manager-role</p>
                                      </div>
                                    </div>
                                    <div className="form-group col-md-12 col-lg-6 my-1 d-flex line-height-24">
                                      <label className=" line-height-24"><p className="text-left mb-0  line-height-24">Campus:</p></label>
